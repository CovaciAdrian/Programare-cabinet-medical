            ...
            switch (comanda) {
                ...
                case 4: {
                    ...
                    for(int i=0; i< medic.length; i++){
                        ...
                        if(medic[i].getSpecialitateMedic() == "chirurg") {
                    ...
                    for(int i=0; i< medic.length; i++){
                        ...
                        if(medic[i].getSpecialitateMedic() == "familie") {
                    ...
                    for(int i=0; i< medic.length; i++){
                        ...
                        if(medic[i].getSpecialitateMedic() == "ortoped") {
                            System.out.println( "Medicul " + medic[i].getNumeMedic() + " este " + medic[i].getSpecialitateMedic());
                        }
                    ...
                    for(int i=0; i< medic.length; i++){
                        ...
                        if(medic[i].getSpecialitateMedic() == "psihiatru") {
                ...
                case 5: {
                    ...
                    for (int i = 0; i < medic.length; i++) {
                        ...
                        for (int j = 0; j < pacient.length; j++) {
                            ...
                            if(pacient[j]!=null)
                                if (pacient[j].getProblemaClient() == medic[i].getSpecialitateMedic() && pacient[j].getAles() == 0 )
